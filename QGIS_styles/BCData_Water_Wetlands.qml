...
<qgis hasScaleBasedVisibilityFlag="0" readOnly="0" version="3.12.2-București" styleCategories="AllStyleCategories" simplifyDrawingHints="1" simplifyMaxScale="1" simplifyDrawingTol="1" maxScale="-4.656612873077393e-10" simplifyAlgorithm="0" labelsEnabled="0" simplifyLocal="1" minScale="100000000">
  <flags>
    ...
    <symbols>
      <symbol type="fill" alpha="1" clip_to_extent="1" name="0" force_rhr="0">
        <layer enabled="1" pass="0" locked="0" class="SimpleFill">
          ...
          <prop v="208,221,227,255" k="color"/>
        ...
        <layer enabled="1" pass="0" locked="0" class="SVGFill">
          ...
          <prop v="15,114,180,255" k="outline_color"/>
          ...
          <prop v="symbol/landuse_swamp.svg" k="svgFile"/>
          ...
          <symbol type="line" alpha="1" clip_to_extent="1" name="@0@2" force_rhr="0">
            <layer enabled="1" pass="0" locked="0" class="SimpleLine">
              <prop v="square" k="capstyle"/>
              <prop v="5;2" k="customdash"/>
              <prop v="3x:0,0,0,0,0,0" k="customdash_map_unit_scale"/>
  ...
  <customproperties>
    ...
    <property value="no label" key="qgis2web/popup/AREA_HA"/>
    <property value="no label" key="qgis2web/popup/BLUE_LINE_"/>
    <property value="no label" key="qgis2web/popup/FEATURE_CO"/>
    <property value="no label" key="qgis2web/popup/FWA_WATERS"/>
    <property value="no label" key="qgis2web/popup/GNIS_ID_1"/>
    <property value="no label" key="qgis2web/popup/GNIS_ID_2"/>
    <property value="no label" key="qgis2web/popup/GNIS_ID_3"/>
    <property value="no label" key="qgis2web/popup/GNIS_NAME_"/>
    <property value="no label" key="qgis2web/popup/GNIS_NAM_1"/>
    <property value="no label" key="qgis2web/popup/GNIS_NAM_2"/>
    <property value="no label" key="qgis2web/popup/LEFT_RIGHT"/>
    <property value="no label" key="qgis2web/popup/LOCAL_WATE"/>
    <property value="no label" key="qgis2web/popup/OBJECTID"/>
    <property value="no label" key="qgis2web/popup/SHAPE_Area"/>
    <property value="no label" key="qgis2web/popup/SHAPE_Leng"/>
    <property value="no label" key="qgis2web/popup/WATERBODY_"/>
    <property value="no label" key="qgis2web/popup/WATERBOD_1"/>
    <property value="no label" key="qgis2web/popup/WATERBOD_2"/>
    <property value="no label" key="qgis2web/popup/WATERBOD_3"/>
    <property value="no label" key="qgis2web/popup/WATERBOD_4"/>
    <property value="no label" key="qgis2web/popup/WATERSHED_"/>
    <property value="no label" key="qgis2web/popup/WATERSHE_1"/>
    <property value="no label" key="qgis2web/popup/WATERSHE_2"/>
    <property value="no label" key="qgis2web/popup/WATERSHE_3"/>
    <property value="no label" key="qgis2web/popup/WATERSHE_4"/>
  ...
  <fieldConfiguration>
    ...
    <field name="WATERBODY_KEY_GROUP_CODE_50K">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias index="1" field="WATERBODY_POLY_ID" name=""/>
    <alias index="2" field="WATERSHED_GROUP_ID" name=""/>
    <alias index="3" field="WATERBODY_TYPE" name=""/>
    <alias index="4" field="WATERBODY_KEY" name=""/>
    <alias index="5" field="AREA_HA" name=""/>
    <alias index="6" field="GNIS_ID_1" name=""/>
    <alias index="7" field="GNIS_NAME_1" name=""/>
    <alias index="8" field="GNIS_ID_2" name=""/>
    <alias index="9" field="GNIS_NAME_2" name=""/>
    <alias index="10" field="GNIS_ID_3" name=""/>
    <alias index="11" field="GNIS_NAME_3" name=""/>
    <alias index="12" field="BLUE_LINE_KEY" name=""/>
    <alias index="13" field="WATERSHED_KEY" name=""/>
    <alias index="14" field="FWA_WATERSHED_CODE" name=""/>
    <alias index="15" field="LOCAL_WATERSHED_CODE" name=""/>
    <alias index="16" field="WATERSHED_GROUP_CODE" name=""/>
    <alias index="17" field="LEFT_RIGHT_TRIBUTARY" name=""/>
    <alias index="18" field="WATERBODY_KEY_50K" name=""/>
    <alias index="19" field="WATERSHED_GROUP_CODE_50K" name=""/>
    <alias index="20" field="WATERBODY_KEY_GROUP_CODE_50K" name=""/>
    <alias index="21" field="WATERSHED_CODE_50K" name=""/>
    <alias index="22" field="FEATURE_CODE" name=""/>
    <alias index="23" field="OBJECTID" name=""/>
    <alias index="24" field="SE_ANNO_CAD_DATA" name=""/>
    <alias index="25" field="FEATURE_AREA_SQM" name=""/>
  ...
  <defaults>
    ...
    <default expression="" applyOnUpdate="0" field="WATERBODY_POLY_ID"/>
    <default expression="" applyOnUpdate="0" field="WATERSHED_GROUP_ID"/>
    <default expression="" applyOnUpdate="0" field="WATERBODY_TYPE"/>
    ...
    <default expression="" applyOnUpdate="0" field="WATERBODY_KEY_50K"/>
    <default expression="" applyOnUpdate="0" field="WATERSHED_GROUP_CODE_50K"/>
    <default expression="" applyOnUpdate="0" field="WATERBODY_KEY_GROUP_CODE_50K"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="0" unique_strength="0" constraints="0" field="WATERBODY_POLY_ID" exp_strength="0"/>
    <constraint notnull_strength="0" unique_strength="0" constraints="0" field="WATERSHED_GROUP_ID" exp_strength="0"/>
    <constraint notnull_strength="0" unique_strength="0" constraints="0" field="WATERBODY_TYPE" exp_strength="0"/>
    ...
    <constraint notnull_strength="0" unique_strength="0" constraints="0" field="WATERBODY_KEY_50K" exp_strength="0"/>
    <constraint notnull_strength="0" unique_strength="0" constraints="0" field="WATERSHED_GROUP_CODE_50K" exp_strength="0"/>
    <constraint notnull_strength="0" unique_strength="0" constraints="0" field="WATERBODY_KEY_GROUP_CODE_50K" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" field="WATERBODY_POLY_ID" exp=""/>
    <constraint desc="" field="WATERSHED_GROUP_ID" exp=""/>
    <constraint desc="" field="WATERBODY_TYPE" exp=""/>
    ...
    <constraint desc="" field="WATERBODY_KEY_50K" exp=""/>
    <constraint desc="" field="WATERSHED_GROUP_CODE_50K" exp=""/>
    <constraint desc="" field="WATERBODY_KEY_GROUP_CODE_50K" exp=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" type="field" name="WATERBODY_POLY_ID" hidden="0"/>
      <column width="-1" type="field" name="WATERSHED_GROUP_ID" hidden="0"/>
      <column width="-1" type="field" name="WATERBODY_TYPE" hidden="0"/>
      ...
      <column width="-1" type="field" name="WATERBODY_KEY_50K" hidden="0"/>
      <column width="-1" type="field" name="WATERSHED_GROUP_CODE_50K" hidden="0"/>
      <column width="-1" type="field" name="WATERBODY_KEY_GROUP_CODE_50K" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="WATERBODY_KEY_50K"/>
    <field editable="1" name="WATERBODY_KEY_GROUP_CODE_50K"/>
    <field editable="1" name="WATERBODY_POLY_ID"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="WATERBODY_KEY_50K"/>
    <field labelOnTop="0" name="WATERBODY_KEY_GROUP_CODE_50K"/>
    <field labelOnTop="0" name="WATERBODY_POLY_ID"/>
    <field labelOnTop="0" name="WATERBODY_TYPE"/>
